        ...
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mButton == v) {
                    ...
                    if (createNewEditText().getTag().equals("a1")||createNewEditText().getTag().equals("a2")||createNewEditText().getTag().equals("a3")||createNewEditText().getTag().equals("a4")
                            ||createNewEditText().getTag().equals("a5")||createNewEditText().getTag().equals("a6")||createNewEditText().getTag().equals("a7")||createNewEditText().getTag().equals("a8")||createNewEditText().getTag().equals("a9")||createNewEditText().getTag().equals("a10")) {
...
*/
    ...
    public void gåvidere() {
        Intent intent = new Intent(LederOpretMoedeActivity.this, deltagerDagsordenActivity.class);
